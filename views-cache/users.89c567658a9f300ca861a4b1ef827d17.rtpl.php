  		...
  		<div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tbody>                  
                  <!-- FUNÇÃO DO RainTPL USADA PARA DAR UM LOOP (FUNCIONA COMO UM FOREACH). ELE VAI REPETIR OQ ESTÁ DENTRO ENTRE AS CHAVES DE ABERTURA E FECHAMENTO ATÉ QUE NÃO HAJA MAIS NENHUM DADO -->
